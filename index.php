...
<body data-spy="scroll" data-target=".navbar" data-offset="0">
 <header id="start">
  <div id="banner" class="row">
   <ul class="backgrounds list-unstyled">
    <li>
     <span>Image 1</span>
    </li>
   </ul>
  ...
  <div class="jumbotron">
   <div class="container">
    ...
    <h1>I'm Tim Veluwenkamp</h1>
    <h3>I Design &amp; Build Beautiful Crafted Web Experiences</h3>
   </div>
  </div>
  ...
  <p class="bg-info text-center" style="padding: 10px 0; margin-bottom: 0px;">My website is still under active development...</p>
 </header>
 <!--[if lt IE 8]>
  ...
  <div class="container">
   ...
   <div class="row">
    <div class=" col-xs-12 col-sm-12 col-md-8">
     <h4>Tim Veluwenkamp
      <br/>
      <small>Web Developer from Arnhem</small>
     </h4>
     <p>I'm obsessed with making things and even more obsessed with making things better. I created me first website at the age of 11 with the help of Microsoft Frontpage. After graduating school I got in touch with NoXqs a Software Company with some unique
      and special people, I have been working here since October 2010 now and I still love my work! </p>
 ...
 <section id="skills">
  <div class="container">
   <div class="page-header">
    <h2>Skills
     <small>I can say I'm quite good at</small>
    </h2>
   </div>
   <div class="row">
    <div class="col-xs-6 col-md-3 skill">
    ...
    <div class="col-xs-6 col-md-3 skill">
     ...
     <h4>WINDOWS XP, 7, 8 &amp; SERVER 2008</h4>
    </div>
    <div class=" col-xs-6 col-md-3 skill">
     <span class="chart" data-percent="75">
      <span class="percent"></span>
     </span>
     <h4>ABBYY FINEREADER OCR &amp; KURTWEIL 3000</h4>
    </div>
    <div class="col-xs-6 col-md-3 skill">
     <span class="chart" data-percent="70">
      <span class="percent"></span>
     </span>
     <h4>MOBILE DEVELOPMENT (ANDROID &amp; IOS)</h4>
    </div>
    <div class="col-xs-6 col-md-3 skill">
     <span class="chart" data-percent="70">
      <span class="percent"></span>
 ...
 <section id="experience">
  <div class="container">
   <div class="page-header">
    <h2>Work Experience
     <small>My previous associations</small>
    </h2>
   </div>
   <div class="row">
    <div class="col-xs-4 col-md-2">
     <div class="years">Oct, 2010
      <br/>Present</div>
    </div>
    <div class="col-xs-8 col-md-10 details">
     <h4>Systems- &amp; Network Engineer
      <br/>
      <small><i class="fa fa-map-marker"> </i><a href="https://plus.google.com/105807787564855848545/about"> NoXqs B.V., Elst (gld)</a></small>
     </h4>
     <p>NoXqs makes apps, web applications and websites. The expertise lies in the easy accessibility of technology and information. The company now has about 25 employees. The mission of the company is "going for the possibilities." In other words, go for the capabilities of the software users, including many people with intellectual disabilities. NoXqs also goes for the potential of employees; including many professionals with a form of autism.</p>
    </div>
   </div>
   <div class="row">
    <div class="col-xs-4 col-md-2">
     <div class="years">2008
      <br/>Sept, 2010
     </div>
    </div>
    <div class="col-xs-8 col-md-10 details">
     <h4>ICT Coördinator Assistant
      <br/>
      <small><i class="fa fa-map-marker"> </i><a href="http://prisma-arnhem.nl"> Het Prisma, Arnhem</a></small>
     </h4>
   ...
   <div class="row">
    ...
    <div class="col-xs-8 col-md-10 details">
     <h4>Employee Computer Advies Team
      <br/>
 ...
 <section id="education">
  <div class="container">
   <div class="page-header">
    <h2>Education &amp; Diploma's
     <small>My (boring) education carreer </small>
    </h2>
   </div>
   <div class="row">
    <div class="col-xs-8 col-md-10 details">
     <h4>Practical Sector Orientation (VMBO)
      <br/>
      <small><i class="fa fa-map-marker"> </i> <a href="http://www.mariendael.nl/">Mariëndael, Arnhem</a></small>
     </h4>
    ...
    <div class="col-xs-8 col-md-10 details">
     <h4>Basic Education
      <br/>
      <small><i class="fa fa-map-marker"> </i> <a href="http://www.ssonml.nl/ulingshof/">Mytylschool Ulingshof, Venlo</a></small>
     </h4>
 ...
 <section id="portfolio">
  <div class="container">
   ...
   <ul class="nav nav-tabs">
    ...
    <li><a href="#logos" data-toggle="tab">Logo's</a></li>
   ...
   <div class="tab-content">
    ...
    <!--.tab-pane -->
    <div class="tab-pane active" id="logos">
     <div class="row">
    ...
    <div class="tab-pane active" id="other">
     <div class="row">
      <?php require_once ("portfolio/other/index.php"); ?>
     </div>
     <!--.row-->
    </div>
    <!--.tab-pane -->
   ...
   <div class="row">
    ...
    <div class="col-xs-12 col-md-4">
     <div class="col-xs-6 col-md-6">
      <p><a type="button" class="btn btn-lg btn-block btn-default" href="https://bitbucket.org/TimVNL" target="_blank"><i class="fa fa-bitbucket"></i> Bitbucket</a></p>
